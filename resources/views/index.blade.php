...
@section('content')
        ...
        <!-- slider Area Start-->
        <div class="slider-area slider-height" data-background="{{asset('frontend/loan/img/hero/h1_hero.jpg')}}">
            <div class="slider-active">
                ...
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                        ...
                        <div class="hero__img">
                            <img src="{{asset('frontend/loan/img/hero/hero_img.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
                <!-- Single Slider -->
                <div class="single-slider">
                    <div class="slider-cap-wrapper">
                        ...
                        <div class="hero__img">
                            <img src="{{asset('frontend/loan/img/hero/hero_img2.jpg')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="footer-wrapper">
                    ...
                    <div class="single-caption">
                        <div class="single-img">
                            <img src="{{asset('frontend/loan/img/hero/hero_footer.png')}}" alt="">
                        </div>
                    </div>
                    <!-- single -->
                    <div class="single-caption">
        ...
        <!-- slider Area End-->
        <!-- About Law Start-->
        <div class="about-low-area section-padding2" id="about">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="{{asset('frontend/loan/img/gallery/about2.png')}}" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="{{asset('frontend/loan/img/gallery/about1.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- About Law End-->
        <!-- Services Area Start -->
        <div class="services-area pt-150 pb-150" data-background="{{asset('frontend/loan/img/gallery/section_bg02.jpg')}}" id="services">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Personal Loan</a></h5>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Home Loan</a></h5>
                                <p>Consectetur adipisicing elit, sed doeiusmod tempor incididunt ut labore et dolore</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="single-cat text-center mb-50">
                            ...
                            <div class="cat-cap">
                                <h5><a href="services.php">Car Loan</a></h5>
                                <p>Consectetur adipisicing elit, sed doeiusmod tempor incididunt ut labore et dolore</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6">
                        <div class="support-location-img mb-50">
                            <img src="{{asset('frontend/loan/img/gallery/single2.jpg')}}" alt="">
