...
@section('titel', 'Party | Atal Media')
@section('content')
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Party List</h1>
            
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Party</li>
                <li class="breadcrumb-item active"><a href="#">Party List</a></li>
            </ul>
        </div>
        ...
        <div class="">
            <a class="btn btn-primary" href="{{route('customer.create')}}"><i class="fa fa-plus"> Add Party</i></a>
        </div>
